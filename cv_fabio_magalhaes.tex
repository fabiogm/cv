...
\moveleft.5\hoffset\centerline{Porto Alegre, Rio Grande do Sul, Brazil} % Your address
\moveleft.5\hoffset\centerline{+55 51 98216 1084}
\moveleft.5\hoffset\centerline{fmagalhaes@gmail.com}
\moveleft.5\hoffset\centerline{GitHub: https://github.com/fabiogm}

\begin{resume}

\section{ABOUT} Software engineer with over eight years of experience. Pragmatic, always striving to keep balance between technical excellence
  and business value delivery. Worked on projects ranging from greenfield applications to large legacy systems, across diverse industries like retail, 
  healthcare and banking. Currently working as a back-end engineer and leading a small team.

\section{COMPUTER \\ SKILLS} {\sl Programming Languages:} Java, Python, Ruby, Javascript, Node.js, SQL, R, C, C++\\
    {\sl Databases, Data Stores \& Tools:} PostgreSQL, MongoDB, Hive, HBase\\
